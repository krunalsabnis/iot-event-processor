...
@Component
@Slf4j
public class CarFuelEventAdapter implements IoTEventAdapter {
    private final EventRepository eventRepository;

    @Autowired
    public CarFuelEventAdapter(EventRepository eventRepository) {
    ...
    public void processEvent(IoTEvent event) {
        log.info("processing CAR_FUEL event {}", event);
